// OBS: usar fones distantes dos ouvidos, muito agudo
...
int length; // Comprimento da música

void setup() // Definindo o pino e tempo de musica
{
  pinMode(7, OUTPUT);
  length = sizeof(tune) / sizeof(tune[0]);
}

void loop() // incio da musica, pausa, recomeça a musica 
{
